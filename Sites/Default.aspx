                            ...
                            <div class="Marginer2">
                                ...
                                <div>
                                    <asp:DataList ID="dlSites" EnableViewState="false" RepeatColumns="4" RepeatDirection="Horizontal"
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink NavigateUrl='<%#"https://www.khabardaan.ir/Sites/?CatID=" + DataBinder.Eval(Container.DataItem, "ID")%>'
                                    ...
                                    <ItemTemplate>
                                        <div class="<%= GetClass()%>">
                                            <div class="SingleSite">
                                                <div class="Link">
                                                    <asp:HyperLink Target="_blank" runat="server" NavigateUrl='<%#"https://www.khabardaan.ir/Sites/Direct/?SiteID=" + DataBinder.Eval(Container.DataItem, "ID")%>'>
                                    <%#DataBinder.Eval(Container.DataItem, "Url")%>
                                                    </asp:HyperLink>
                                                </div>
                                                <div class="LinkTitle">
                                                    <asp:HyperLink Target="_blank" ID="HyperLink3" runat="server" NavigateUrl='<%#"https://www.khabardaan.ir/Sites/Direct/?SiteID=" + DataBinder.Eval(Container.DataItem, "ID")%>'>
