                        ...
                        <div class="Box4">
                            <div class="Marginer2">
                                ...
                                <asp:DataList ID="dlSites" RepeatColumns="4" RepeatDirection="Horizontal" CssClass="tblSiteCats"
                                    runat="server">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" NavigateUrl='<%#"https://www.khabardaan.ir/Sites/?CatID=" + DataBinder.Eval(Container.DataItem, "ID")%>'
                                    ...
                                    <ItemTemplate>
                                        <div class="<%= GetClass()%>">
                                            <div class="SingleSite">
                                                <div class="Link">
                                                    <asp:HyperLink ID="HyperLink2" runat="server" Target="_blank" NavigateUrl='<%#"https://www.khabardaan.ir/Sites/Direct/?SiteID=" + DataBinder.Eval(Container.DataItem, "ID")%>'>
                                    <%#DataBinder.Eval(Container.DataItem, "Url")%>
                                                    </asp:HyperLink>
                                                </div>
                                                <div class="LinkTitle">
                                                    <asp:HyperLink ID="HyperLink3" Target="_blank" runat="server" NavigateUrl='<%#"https://www.khabardaan.ir/Sites/Direct/?SiteID=" + DataBinder.Eval(Container.DataItem, "ID")%>'>
