<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root1.master" CodeBehind="Default.aspx.cs" Title="درباره ربات خبریاب خبردان"
...
<div class="WinRadiusGray">
    <div class="CatHeaderCont">
            <h3 class="CatHeader">
                <asp:Label ID="lblCatTitle" Text="درباره ربات خبردان "
        ...
        <div class="KhabardaanList">
            <div class="Marginer1">
                <div class="Box3">
                    ...
                    <div class="Marginer2">
                        <div class="Farsi" >
                            ربات جستجوگر خبردان منابع خبری تعریف شده نظیر ایسنا ، ایرنا ، همشهری آنلاین و ... را بطور متناوب
                            ...
                            با ذکر منبع آن در سایت خبردان منتشر میشود.
                            <br />
                            کلمات کلیدی خبر یا همان Tag های خبر بصورت خودکار از روی متن خبر استخراج میشود و
                            با استفاده از این کلمات کلیدی میتوان خبرهای مربوط به یک موضوع خاص را بازیافت نمود.
                            مثلا خبرهای مربوط به سازمان ملل از طریق <a href="https://www.khabardaan.ir/News/Keywords/3585.htm" style="text-decoration:underline;">این
                                آدرس</a> قابل دریافت است.<br />
                            <br />
                            &nbsp;ارزش افزوده دیگری که هر خبر از طریق این سیستم پیدا میکند ، اخبار مرتبط است
                            بدین شکل که در موقع ذخیره خبر ، از طریق الگوریتمهای بکار رفته در سایت خبردان خبرهای
							...
							<a href="http://Khabardaan.ir/ContactUs.aspx">با ما ارتباط برقرار کنید.</a>
                        </div>
