<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master2Col.Master"
    CodeBehind="AllNews.aspx.cs" Inherits="Khabardaan.News.AllNews" %>
                    ...
                    <ItemTemplate>
                        <div>
                            <asp:HyperLink ID="HyperLink1" Target="_blank" ToolTip='<%#DataBinder.Eval(Container.DataItem, "Title") %>'
                                NavigateUrl='<%#"https://www.khabardaan.ir/News/" + Eval("Code") + "_" + Tools.ConvertFarsiToPingilish(Eval("Title")) + ".html" %>'
                                Text='<%#Tools.ShowBriefText(DataBinder.Eval(Container.DataItem, "Title"),60)%>'
                                runat="server"></asp:HyperLink>-&nbsp;<span class="cResource"><asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%#"https://www.khabardaan.ir/NR" + Eval("ResourceSiteCode") + "_" + Tools.ReplaceSpaceWithUnderline(Eval("Title")) + ".html"%>' Target="_blank"><%#DataBinder.Eval(Container.DataItem, "ResourceName")%></asp:HyperLink></span>&nbsp;<span
