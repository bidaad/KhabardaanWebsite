<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/RootNoCol.master" CodeBehind="URNewsByResource.aspx.cs" Inherits="Khabardaan.News.URNewsByResource" %>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="panel">
                            ...
                            <div class="ByKhabardaan">
                                گردآوری اخبار بوسیله ربات جستجوگر <a href="http://www.Khabardaan.ir" target="_blank">پارست</a>
                            </div>
