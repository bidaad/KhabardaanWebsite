<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCNewsFeedTool.ascx.cs"
    Inherits="Khabardaan.UserControls.UCNewsFeedTool" %>
<div>
    <div class="NewsHead1">
        <div>
            اخبار در سایت شما
    ...
    <div>
        <div class="Padder1">
            <textarea id="KhabardaanScript" onclick="SelectText(this)" class="form-control" style="direction: ltr; overflow: hidden;"
                cols="37" rows="3">&lt;script type="text/javascript" src="https://www.khabardaan.ir/Feed"&gt;&lt;/script&gt;</textarea>
        </div>
