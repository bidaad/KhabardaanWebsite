...
{
    Domain = '';
    Domain = 'https://www.khabardaan.ir/Music/';
...
function LoadBanner() {
    try {
        if (checkVersion()) {
            ...
            BannerTag = "<div class='Marginer2'><a href='https://www.khabardaan.ir/?Ref=Khabardaan' target='_blank'><div class='BisstonBanner1'></div></a></div><div class='Clear'></div><br>"
...
{
    try{
        Url = 'https://www.khabardaan.ir/LogBannerClick.aspx?Code=' + ADSCode;
...
function ChangeScript(SelectObj, ComboType) {
    if (ComboType == 'Cat') {
        if (SelectObj.value == '0')
            document.getElementById('KhabardaanScript').value = '<script type="text/javascript" src="https://www.khabardaan.ir/Feed/"></script>'
        else
            document.getElementById('KhabardaanScript').value = '<script type="text/javascript" src="https://www.khabardaan.ir/Feed/?c=' + SelectObj.value + '"></script>'
    }
    else if (ComboType == 'Res') {
        if (SelectObj.value == '0')
            document.getElementById('KhabardaanScript').value = '<script type="text/javascript" src="https://www.khabardaan.ir/Feed/"></script>'
        else
            document.getElementById('KhabardaanScript').value = '<script type="text/javascript" src="https://www.khabardaan.ir/Feed/?r=' + SelectObj.value + '"></script>'
    }
}
function Hide(obj) {
...
function ReqSendSMS() {
    ...
    Url = 'https://www.khabardaan.ir/ReqSendSMS.aspx?ToCellNo=' + strToCellNo + '&Body=' + escape(SMSBody);
        ...
        if (http_request.readyState == 4) {
            if (http_request.status == 200) {
                ...
                if (result == 'REDIRECTTOPAY') {
                    window.location.href = 'https://www.khabardaan.ir/Users/PaySMSStep1.aspx';
                    return;
                }
...
function submitSearch()
{
    ...
    {
        Url = 'http://www.google.com/search?hl=en&tbo=d&output=search&sclient=psy-ab&q=site%3Awww.Khabardaan.ir+' + objKeyword.value
        window.location.href= Url;
    }
}
function ShowPopupLink() {
    Link = window.location.href;
    window.open('https://www.khabardaan.ir/SendLink.aspx?Link=' + escape(Link), 'SendLink', 'width=500,height=400')
}
