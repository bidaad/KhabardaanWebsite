                                ...
                                <div style="text-align: right">
                                    <div class="FormRow">
                                        <div class="FormList">
                                            ...
                                            <asp:TextBox ID="txtName" CssClass="form-control" Width="300" runat="server"></asp:TextBox>
                                    ...
                                    <div class="FormRow">
                                        <div class="FormList">
                                            ...
                                            <asp:TextBox ID="txtEmail" CssClass="form-control" Width="300" SkinID="English" runat="server"></asp:TextBox>
                                    ...
                                    <div class="FormRow">
                                        <div class="FormList">
                                            ...
                                            <asp:TextBox ID="txtComment" CssClass="form-control" TextMode="MultiLine" Width="300" Rows="7" runat="server"></asp:TextBox>
                                    ...
                                    <div style="text-align: left; padding-left: 150px; padding-top: 5px;">
                                        <asp:LinkButton ID="btnSend" CssClass="btn btn-warning" Text="ارسال" runat="server" OnClick="btnSend_Click"></asp:LinkButton>
                                    </div>
                                </div>
                            </asp:Panel>
                        </div>
