                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div class="panel">
                        ...
                        <div class="PicNewsFirst" id="PicNews">
                            ...
                            <asp:Repeater ID="rptKhabardaanPicNews" Visible="false" EnableViewState="false" runat="server">
                                <HeaderTemplate>
                                    <div class="PicNews">
                                </HeaderTemplate>
                                <ItemTemplate>
                                    ...
                                    <div class="PicItem">
                                        <asp:HyperLink ID="HyperLink5" Target="_blank" runat="server" CssClass="cEngTitle"
                                            NavigateUrl='<%#"https://www.khabardaan.ir/News/" +DataBinder.Eval(Container.DataItem, "Code")  + ".htm"%>'>
                                            <asp:Image ID="Image1" ImageUrl='<%#"//static.Khabardaan.ir/Files/News/" + Eval("PicName") %>' ToolTip='<%#Eval("Title") %>'
                                                runat="server" />
                                        </asp:HyperLink>
                                    </div>
