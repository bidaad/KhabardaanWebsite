<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="Khabardaan.Admin.UserLogin" %>

<%@ Register Src="~/UserControls/AdminLogin.ascx" TagName="AdminLogin" TagPrefix="UC" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Khabardaan Administration</title>
...
<body>
    ...
    <div id="wrap">
        ...
        <div class="homeLable">
            ...
            <br />
            <span id="ctl00_lblFooter2">طراحی و پیاده سازی:</span> <a href="http://Khabardaan.ir"
