<%@ Page Language="C#" MasterPageFile="~/Root1.master" AutoEventWireup="true"
    Inherits="Users_Communities" Title="گروه ها" Codebehind="Communities.aspx.cs" %>
                ...
                <div style="direction:rtl;text-align:right !important;">
                    ...
                    <div>
                        <table>
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtCommunityKeyword" Width="360" runat="server"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:LinkButton ID="btnSearchCommunities" Text="جستجو" CssClass="button1" runat="server"
                                        OnClick="btnSearchCommunities_Click"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </div>
