...
{
    try{
        Url = 'http://www.parset.com/LogBannerClick.aspx?Code=' + ADSCode;
...
function ChangeScript(SelectObj, ComboType) {
    if (ComboType == 'Cat') {
        if (SelectObj.value == '0')
            document.getElementById('ParsetScript').value = '<script type="text/javascript" src="http://www.parset.com/Feed/"></script>'
        else
            document.getElementById('ParsetScript').value = '<script type="text/javascript" src="http://www.parset.com/Feed/?c=' + SelectObj.value + '"></script>'
    }
    else if (ComboType == 'Res') {
        if (SelectObj.value == '0')
            document.getElementById('ParsetScript').value = '<script type="text/javascript" src="http://www.parset.com/Feed/"></script>'
        else
            document.getElementById('ParsetScript').value = '<script type="text/javascript" src="http://www.parset.com/Feed/?r=' + SelectObj.value + '"></script>'
    }
}
function Hide(obj) {
...
function ReqSendSMS() {
    ...
    Url = 'http://www.parset.com/ReqSendSMS.aspx?ToCellNo=' + strToCellNo + '&Body=' + escape(SMSBody);
        ...
        if (http_request.readyState == 4) {
            if (http_request.status == 200) {
                ...
                if (result == 'REDIRECTTOPAY') {
                    window.location.href = 'http://www.parset.com/Users/PaySMSStep1.aspx';
                    return;
                }
...
function submitSearch()
{
    ...
    {
        Url = 'http://www.google.com/search?hl=en&tbo=d&output=search&sclient=psy-ab&q=site%3Awww.parset.com+' + objKeyword.value
        window.location.href= Url;
    }
}
function ShowPopupLink() {
    Link = window.location.href;
    window.open('http://www.parset.com/SendLink.aspx?Link=' + escape(Link), 'SendLink', 'width=500,height=400')
}
