<%@ Page Language="C#" MasterPageFile="~/RootNoCol.master" Title="پارست :: نیازمندی"
    AutoEventWireup="true" Inherits="Ads_Default" CodeBehind="Default.aspx.cs" %>
            ...
            <div class="WinRadiusGray Padder5">
                <div class="form-inline">
                    ...
                    <div class="form-group">
                        <asp:TextBox ID="txtKeyword" CssClass="form-control" placeholder="جستجو" runat="server"></asp:TextBox>
                    </div>
                     <div class="form-group">
                        <asp:ImageButton ID="btnSearch" ImageUrl="~/images/btnSearch.png" runat="server" OnClick="btnSearch_Click" />
                    </div>
                </div>
            </div>
