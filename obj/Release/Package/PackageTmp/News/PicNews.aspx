<%@ Page Language="C#" AutoEventWireup="true" Title="تصاویر خبری" MasterPageFile="~/RootNoCol.master"
    CodeBehind="PicNews.aspx.cs" Inherits="EngParset.News.PicNews" %>
                                    ...
                                    <li>
                                        <div class="PicItem">
                                            <asp:HyperLink ID="HyperLink1" Target="_blank" ToolTip='<%#Eval("Title") %>' runat="server"
                                                CssClass="cTitle" NavigateUrl='<%#"http://www.parset.com/News/" +DataBinder.Eval(Container.DataItem, "Code")  + ".htm"%>'><%#ShowPic(DataBinder.Eval(Container.DataItem, "Title"),DataBinder.Eval(Container.DataItem, "PicName"))%></asp:HyperLink>
                                        </div>
                                    </li>
                                </ItemTemplate>
                                <FooterTemplate>
