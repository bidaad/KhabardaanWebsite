<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root1.master" CodeBehind="ShowContent.aspx.cs"
    Inherits="Parset.Contents.ShowContent" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CP1" runat="Server">
    ...
    <div class="WinRadiusGray">
        <UCST:ShareTools runat="server"></UCST:ShareTools>
    </div>
