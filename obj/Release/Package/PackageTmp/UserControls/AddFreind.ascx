        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                    &times;</button>
                <h4 class="modal-title">ارسال تقاضای دوستی</h4>
            </div>
                        ...
                        <div>
                            ...
                            <div class="form-inline">
                                ...
                                <div class="Padder5">
                                    ...
                                    <asp:Button ID="btnAddFriend" OnClick="btnAddFriend_Click" CssClass="btn btn-primary" OnClientClick="MakeReadonly(this)"
...
<script type="text/javascript">
    $(document).ready(function () {
        try{
            $("#divSendMessage").modal('hide');
            $("#divAddFriendReq").modal('show');
        }
        catch (err) {
        }
    });
