                ...
                <tr>
                    <td colspan="2">
                        <table>
                            <tr>
                                <td>
                                    <asp:Button ID="btnCancelSendMessage" CssClass="btn btn-info" OnClick="btnCancelSendMessage_Click" runat="server"
                                        Text="انصراف" />
                                </td>
                                <td>
                                    <asp:Button ID="btnSendMessage" CssClass="btn btn-info" OnClick="btnSendMessage_Click" runat="server" Text=" ارسال " />
                                </td>
                            </tr>
                        </table>
                    </td>
