...
<div class="HeadNews">
    <div class="NewsContainer">
        <asp:Repeater ID="rptRandNews" EnableViewState="false" runat="server">
            ...
            <ItemTemplate><li><div class="NewsTitle"><asp:HyperLink Target="_blank" ToolTip='<%#DataBinder.Eval(Container.DataItem, "Title") %>' NavigateUrl='<%#"http://www.parset.com/FaNews/" + Eval("Code") + "_" + Tools.ConvertFarsiToPingilish(Eval("Title")) + ".html" %>'
                            Text='<%#Tools.ShowBriefText(DataBinder.Eval(Container.DataItem, "Title"),60)%>'
                            runat="server"></asp:HyperLink>-&nbsp;<span class="cResource"><asp:HyperLink runat="server" NavigateUrl='<%#"http://www.parset.com/NR" + Eval("ResourceSiteCode") + "_" + Tools.ReplaceSpaceWithUnderline(Eval("ResourceName")) + ".html"%>'><%#DataBinder.Eval(Container.DataItem, "ResourceName")%></asp:HyperLink></span>&nbsp;<span
