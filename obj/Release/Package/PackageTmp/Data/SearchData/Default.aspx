<%@ Page Language="C#" MasterPageFile="~/Root1.master" AutoEventWireup="true" Inherits="Data_SearchData_Default"
    Title="اطلاعات عمومی" CodeBehind="Default.aspx.cs" %>
        ...
        <div class="InnerBarWrap">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtKeyword" CssClass="txtKeyword" Width="100" runat="server"></asp:TextBox>
                    </td>
                    <td>
