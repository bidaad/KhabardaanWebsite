<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root1.master" CodeBehind="ShowCat.aspx.cs"
    Inherits="Parset.SMS.ShowCat" %>
                    ...
                    <div class="ParsetList">
                        ...
                        کافی است بر روی آیکون موبایل در کنار هر اس ام اس کلیک کنید و متن آنرا مستقیما به موبایل خود یا دوستانتان ارسال کنید.
                            ...
                            <div class="Box3">
                                ...
                                <div id="SMSObj" class="Marginer3">
                                    <table>
                                        <asp:Repeater ID="rptSMSList" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    
                                                    <td>
                                                        <div id='SMS<%#Eval("Code") %>' class="SMSContent">
                                                            <%#Eval("SMSbody") %>
                                                        </div>
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="tblMainSMSPanel">
                                            <tr>
                                                <td class="SendSMSTools" style="width: 200px;">
                                                    <div>
                                                        <div id="ActualInner" class="SMSInnerArea">
                                                            <asp:Literal ID="ltrSMSContent" EnableViewState="true" runat="server"></asp:Literal>
                                                        </div>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="RTL">
                                                        ...
                                                        اگر عضو سایت باشید 
														میتوانید حساب خود را 
														شارژ کنید و سپس به راحتی 
														اس ام اس های متعدد ارسال 
														کنید.<br />
														امکان ارسال اس ام اس 
														برای کاربران مهمان نیز 
														فراهم است.<br />

                                                        <asp:LinkButton ID="btnPay" OnClick="btnPay_Click" runat="server">پرداخت آنلاین</asp:LinkButton>
                                                        <br />
                                                        <p>
                                                        ...
                                                        <p>
                                                            ...
                                                            نظر خود را دوباره انتخاب کنید.</p>
                                                        <p>
                                                            هزینه ارسال : 
                                                            <asp:Literal ID="ltrSMSCost" runat="server"></asp:Literal> تومان
                                                        </p>
                                                        <p>
                                                            <a target="_blank" class="cColorLink" href="http://www.parset.com/Help/SMSHelp.aspx">
                                                                راهنمای ارسال اس ام اس</a></p>
                                                    </div>
