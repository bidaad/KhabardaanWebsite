<%@ Page Language="C#" MasterPageFile="~/Root1.master" AutoEventWireup="true" Inherits="Culture_Nahj_SearchNahj_Default"
    Title="جستجوی نهج البلاغه" CodeBehind="Default.aspx.cs" %>
    ...
    <div class="WinRadiusGray">
        <div class="WinRadiusGray">
            <div class="CatHeaderCont">
                <h3 class="CatHeader">
                    <asp:Label ID="lblCatTitle" Text="نهج البلاغه"
                ...
                <div class="Marginer1">
                    ...
                    <asp:Repeater ID="rptItems" runat="server" EnableViewState="false">
                        <ItemTemplate>
                            <div class="<%= GetClass()%>">
                                <div class="Aye">
                                    (خطبه&nbsp;<%#Tools.ConvertToUnicode(DataBinder.Eval(Container.DataItem, "Num"))%>
                                    )</div>
                                <div class="Farsi">
                                    <a href='../ShowContent/?ID=<%#DataBinder.Eval(Container.DataItem, "ID") %>'>
                                        <%#Tools.HLText(GetSelText(DataBinder.Eval(Container.DataItem, "Matn")), Keyword)%></a>
                                </div>
                            </div>
                            <div class="clear">
                            </div>
