<%@ Page Language="C#" MasterPageFile="~/Root1.master" AutoEventWireup="true" Inherits="Culture_Quran_Default"
    Title="قرآن" CodeBehind="Default.aspx.cs" %>
                ...
                <div class="Marginer1">
                    ...
                    <div class="Box3">
                        <div class="MainHeader">
                            در اين بخش متن کامل فارسی و عربی قرآن کريم وجود دارد که از طريق انتخاب نام سوره
                        يا جستجو قابل دسترسی مي باشند.
                        </div>
                        <div>
                            <asp:Label ID="lblHeader" CssClass="Header1" runat="server" Text="فهرست سوره ها"></asp:Label>
                        </div>
                        <div class="Clear">
                        </div>
                        <div style="text-align: right">
                            <asp:DataList ID="dtSores" EnableViewState="false" RepeatColumns="8" RepeatDirection="Horizontal"
                                CssClass="tblListItems" runat="server">
                                <ItemTemplate>
                                    <a href="ShowContent/?ID=<%#DataBinder.Eval(Container.DataItem, "ID")%>">
