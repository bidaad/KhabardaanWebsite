...
public class BOLKeywords : BaseBOLKeywords, IBaseBOL<Keywords>
{
    ...
    public object GetList(int StartIndex, int PageSize)
    {
        ...
        return dataContext.vKeywordinNews.Skip(SkipCount).Take(PageSize);
    }
    ...
    public Khabardaan.Code.DAL.Keywords GetKeywordByCode(int KeywordCode)
    {
        Khabardaan.Code.DAL.KeywordsDataContext dc = new Khabardaan.Code.DAL.KeywordsDataContext();
