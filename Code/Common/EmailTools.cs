...
public class EmailTools
{
    ...
    public bool SendAddFriendMessage(Users FromUser, Users ToUser)
    {
        ...
        if (Tools.GetValue(ToUser.IAddMeAsFriend))
        {
            ...
            if (CurTemplate != null)
            {
                ...
                SendResult = tools.SendEmail(MsgBody, MsgSubject, "noreply@Khabardaan.ir", ToUser.Email, "", "");
    ...
    public bool SendInvitationMessage(Users FromUser, string Email)
    {
        ...
        if (CurTemplate != null)
        {
            ...
            SendResult = tools.SendEmail(MsgBody, MsgSubject, "<noreply@Khabardaan.ir>", Email, "", "");
            BOLEmails EmailsBOL = new BOLEmails();
    ...
    public bool SendLikeMessage(Users UserWhoLikes,Users UserWhoCommented, string CommentID)
    {
        ...
        if (CurTemplate != null)
        {
            ...
            SendResult = tools.SendEmail(MsgBody, MsgSubject, "<noreply@Khabardaan.ir>", UserWhoCommented.Email, "", "");
            BOLEmails EmailsBOL = new BOLEmails();
